...
//ASK
static uint8_t pa_table_power_0dB[] = {0x00, 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //0 dB  
static uint8_t pa_table_power_12dB[] = {0x00, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //12 dB
